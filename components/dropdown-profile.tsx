...
import SuissLogo from "@/components/assets/images/SuissMinLogo.svg";
    ...
    <Menu as="div" className="relative inline-flex">
      <Menu.Button className="inline-flex justify-center items-center group">
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium text-app-blue-gray-900 dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200">
            Suiss
          </span>
          <svg
            className="w-3 h-3 shrink-0 ml-1 fill-current text-app-blue-gray-900 dark:text-slate-400"
            viewBox="0 0 12 12"
          >
